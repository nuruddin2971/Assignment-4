...
### 4. What is Event Delegation in JavaScript? Why is it useful?
    ...
    Event Delegation means addEventListener to the parent instead of each child element.
    It is useful because need less addEventListener, fast performance.

### 5. What is the difference between preventDefault() and stopPropagation() methods?

    preventDefault() method stops default action of an element.
    On the other hand, stopPropagation() method stops from going to the upper levels.
